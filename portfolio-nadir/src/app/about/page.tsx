...
export default function About() {
  return (
    <div className="container mx-auto px-4 py-12">
      <h1 className="text-4xl font-bold mb-8 bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">À propos de moi</h1>
      
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4 text-primary">Parcours professionnel 💼</h2>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4 text-primary">Approche professionnelle</h2>
        <p className="text-lg text-muted-foreground">
